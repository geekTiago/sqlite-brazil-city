...
CREATE TABLE IF NOT EXISTS unidade_federativa (
  ...
  nome TEXT NOT NULL,
  uf TEXT NOT NULL,
  fk_pais INTEGER NOT NULL REFERENCES pais(_id)
);

CREATE TABLE IF NOT EXISTS cidade (
  _id INTEGER PRIMARY KEY AUTOINCREMENT,
  nome TEXT NOT NULL,
  fk_unidade_federativa INTEGER NOT NULL REFERENCES unidade_federativa(_id)
);

INSERT INTO pais (_id, nome, sigla) VALUES (1, 'Brasil', 'BR');

INSERT INTO unidade_federativa (_id, nome, uf, fk_pais) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
INSERT INTO cidade (_id, nome, fk_unidade_federativa) VALUES
(1, 'Afonso Cláudio', 8),
